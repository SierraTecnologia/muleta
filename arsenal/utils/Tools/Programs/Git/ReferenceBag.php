 ...
 */
namespace SiUtils\Tools\Programs\Git;

use SiUtils\Tools\Programs\Git\Exception\ReferenceNotFoundException;
use SiUtils\Tools\Programs\Git\Exception\RuntimeException;
use SiUtils\Tools\Programs\Git\Reference\Branch;
use SiUtils\Tools\Programs\Git\Reference\Stash;
use SiUtils\Tools\Programs\Git\Reference\Tag;
...
class ReferenceBag implements \Countable, \IteratorAggregate
{
     ...
     * Repository object.
     *
     * @var SiUtils\Tools\Programs\Git\Repository
     */
     ...
     * Constructor.
     *
     * @param SiUtils\Tools\Programs\Git\Repository $repository The repository
     */
